  ...
  return (
    <section className="min-h-screen p-8 lg:p-20 bg-base-200">
      <div className="p-8 bg-base-300 rounded-lg my-5 lg:px-20 lg:py-12 ">
        <h2 className="text-2xl font-bold my-5 text-gray-600">
      ...
      <div className="p-8 bg-base-300 rounded-lg my-5 lg:px-20 lg:py-12 ">
        ...
        <p className="text-gray-600">
          ...
          &lt;br/&gt;&lt;br/&gt; Let's understand using an example: Suppose you want to build a
          website where you need to store data in a database, so here you will use MongoDB but in
          order to store/retrieve the data you need a medium, here NodeJS acts as a medium to do
          that for you, provides server side application execution.
        </p>
      </div>
      <div className="p-8 bg-base-300 rounded-lg my-5 lg:px-20 lg:py-12 ">
        <h2 className="text-2xl font-bold my-5 text-gray-600">
      ...
      <div className="p-8 bg-base-300 rounded-lg my-5 lg:px-20 lg:py-12 ">
        <h2 className="text-2xl font-bold my-5 text-neutral">
        ...
        <p className="text-neutral">
          ...
          <div className="flex flex-col items-center">
            ...
            <ul className="steps steps-vertical">
              <li className="step">Header</li>
              <li className="step">Payload</li>
              <li className="step">Signature</li>
            </ul>
          </div>
          ...
          receiver.
          <h3 className="font-bold text-2xl my-5">How does it work?</h3>
